...
- Size: 326 MB; native crash limit ~200 s per pass (a rotary positional table in the NeMo export), split automatically at 30 s (quality, not the crash limit: measured degradation above ~60 s per pass)
