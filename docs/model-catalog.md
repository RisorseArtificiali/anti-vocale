...
| Italian | Orukeet multilingual int8 (Parakeet TDT v3 fine-tune, Italian gain, CC BY-SA 4.0) | ~640 MB | [oruk/orukeet](https://huggingface.co/oruk/orukeet) (Parakeet TDT v3 fine-tune; FLEURS-it 2.43 to 2.09 WER per the publisher's paired evidence) | [oruk/orukeet](https://huggingface.co/oruk/orukeet) onnx/sherpa-v0.1.0-int8 (first-party export, 25 languages; drops Turkish and Norwegian) |
