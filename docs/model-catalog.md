...
| Multilingual (all 99 languages, low-RAM) | Whisper Tiny multilingual (sherpa int8, low-RAM) | ~103 MB | [openai/whisper-tiny](https://huggingface.co/openai/whisper-tiny) | [csukuangfj/sherpa-onnx-whisper-tiny](https://huggingface.co/csukuangfj/sherpa-onnx-whisper-tiny) |
