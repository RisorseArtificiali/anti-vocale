# Task: Add HuggingFace Model Download with Authentication
...
- [ ] Add link to HF token settings page
...
### 3. Authentication
- [ ] Modify ModelDownloader to add Authorization: Bearer header
...
3. License acceptance on model page (one-time)
