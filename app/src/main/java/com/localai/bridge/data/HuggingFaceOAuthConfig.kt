 ...
 * 3. Configure:
 *    - **Application name**: LocalAI Bridge (or your preferred name)
 *    - **Homepage URL**: https://github.com/paoloantinori/voice_message_reader
 *    - **Redirect URI**: com.localai.bridge://oauth2callback
...
object HuggingFaceOAuthConfig {
     ...
     */
    const val REDIRECT_URI = "com.localai.bridge://oauth2callback"
