...
class LogsViewModelRetranscribeNamesTest {
    ...
    fun setUp() {
        ...
        viewModel = LogsViewModel(manager, mockk<LogDao>(relaxed = true), preferences, staticRegistry(), mockk(relaxed = true), mockk(relaxed = true), mockk(relaxed = true), mockk(relaxed = true))
    }
