...
Replaced default Android launcher icon with custom Anti-Vocale icon (microphone with duct tape + "AV"). Used separate foreground (transparent) and background (red-orange gradient) layers for adaptive icons on Android 8.0+, plus composite PNGs for older devices. All density buckets (mdpi through xxxhdpi) generated. Commit: 3408690
